  ...
  return (
    <section className="mx-auto my-10 max-w-xl rounded-xl  px-4 py-10 text-gray-700 shadow sm:px-8">
      ...
      <div className="text-center mb-[20px]">
        <h1 className="text-[20px] font-bold text-[#323B4B] ">{title}</h1>
        <p className="text-[14px] font-medium text-[#8A94A6]">{description}</p>
      </div>
      ...
      <p className="text-center text-[12px] font-medium text-primary">
        ...
        <Link
          href={buttonTitle === "Sign Up" ? "/sign-in" : "/sign-up"}
          className="text-[#377DFF] cursor-pointer hover:underline  transition-all duration-500 ease-in-out"
        >
          {buttonTitle === "Sign Up" ? "Sign In" : "Sign Up"}
        </Link>
      </p>
    </section>
  );
